...
<svg class="{{ $class }}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g opacity="0.4">
        <path d="M12 15.0011V3.62109" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
            stroke-linejoin="round" />
        <path d="M15.3484 5.85L11.9984 2.5L8.64844 5.85" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
            stroke-linejoin="round" />
    </g>
</svg>
